...
return function(config)
  vim.list_extend(config.spec, {
    ...
    { import = "user.plugins.extras.colorschemes.catppuccin", enabled = true },
    { import = "user.plugins.extras.colorschemes.everforest", enabled = false },
    { import = "user.plugins.extras.colorschemes.nightfox", enabled = false },
    { import = "user.plugins.extras.colorschemes.onigiri", enabled = false },
    { import = "user.plugins.extras.colorschemes.kanagawa", enabled = false },
    { import = "user.plugins.extras.colorschemes.tokyonight", enabled = false },
    ...
    { import = "user.plugins.extras.tools.neural", enabled = false },
    { import = "user.plugins.extras.tools.neorg", enabled = true },
